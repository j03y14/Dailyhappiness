...
public class MissionCandidateActivity extends AppCompatActivity implements AbsListView.OnScrollListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        missionCandidateListAdapter = new MissionCandidateListAdapter(MissionCandidateActivity.this);
        ...
        binding.iBtnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                OFFSET=20;
                getMissionCandidate(Account.getUserIndex(), 0, 1);
            }
        });
        ...
        retroClient.getMissionCandidate(userIndex,count,mode,new RetroCallback<JsonArray>(){
            ...
            public void onSuccess(int code, JsonArray receivedData) {
                ...
                for(int i =0; i<receivedData.size(); i++){
                    ...
                    missionCandidateListAdapter.addItem(new MissionCandidate(user,missionName,index,likes,dislikes,duplicateCount,likeChecked,dislikeChecked,duplicateChecked));
                }
