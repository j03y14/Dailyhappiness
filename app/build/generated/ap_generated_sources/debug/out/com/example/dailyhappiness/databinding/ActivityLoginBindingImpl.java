...
public class ActivityLoginBindingImpl extends ActivityLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.edtInputID, 1);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.activity == variableId) {
            setActivity((com.example.dailyhappiness.LoginActivity) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setActivity(@Nullable com.example.dailyhappiness.LoginActivity Activity) {
